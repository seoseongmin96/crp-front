...
//     const musicWrap = useRef();
//     const musicImg = useRef();
//     const musicName = useRef();
//     const musicArtist = useRef();
//     const musicAudio = useRef();
//     const musicPlay = useRef();
//     const musicPrevBtn = useRef();
//     const musicNextBtn = useRef();
//     const musicProgress = useRef();
//     const musicProgressBar = useRef();
//     const musicProgressCurrent = useRef();
//     const musicProgressDuration = useRef();
//     const musicRepeat = useRef();
//     const musicList = useRef();
//     const MusicListBtn = useRef();
//     const MusicListClose = useRef();
//     const musicListUl = useRef();
...
//     </div>
//             <div className="wrap__music" ref={musicWrap}>
...
//         {/* <!-- // music__top --> */}
// <div className="music__img" ref={musicImg}>
...
//         {/* <!-- // music__song --> */}
//         <div className="music__progress" ref={musicProgress}>
//           <div className="bar">
...
//         <i id="control-repeat" className="material-icons" ref={musicRepeat} title="전체 반복"
//             >repeat</i>
//             <i id="control-prev" className="material-icons" ref={musicPrevBtn} title="이전곡"
//             >skip_previous</i>
//     <div className="play-pause">
//         <i id="control-play" className="material-icons" ref={musicPlay} title="재생"
//               >play_arrow</i>
//             {/* <!-- <i class="material-icons">pause</i> --> */}
//         </div>
//         <i id="control-next" className="material-icons" ref={musicNextBtn} title="다음곡"
//             >skip_next</i>
//           <i id="control-list" className="material-icons" ref={MusicListBtn} title="재생목록"
//             >queue_music</i>
...
//         {/* <!-- // music__control --> */}
//         <div className="music__list" ref={musicList}>
//         <div className="title">
//             <div>
