...
`
  ...
  <div className="carousel-inner">
    <div className="carousel-item active" data-bs-interval="3000">
      <img src="pen.jpg" height = {630} className="d-block w-100" alt=""/>
    ...
    <div className="carousel-item" data-bs-interval="3000">
      <img src="piano.jpg" height = {630}  className="d-block w-100" alt="piano"/>
    ...
    <div className="carousel-item" data-bs-interval="3000">
      <img src="concert.jpg" height = {630} className="d-block w-100" alt="concert"/>
...
<div className='contents'>
  ...
  <img src="score.jpg" height = {630} className="d-block w-100" alt="score"/> <br/><br/><br/><br/>
      <article className='product0'>
        <h2>
        CRP만의 분석 프로그램을 이용해보세요
        <br/><br/>
        <Link href="/analysis/anupload"><a className="btn btn-secondary" >바로가기 &raquo;</a></Link>
        </h2>
      </article>

      <img src="piano3.jpg" height = {630} className="d-block w-100" alt="piano3"/> <br/><br/><br/><br/>
      <article className='product1'>
        <h2>
        CRP만의 표절 프로그램을 이용해보세요
        <br/><br/>
        <Link href="/plagiarism/plupload"><a className="btn btn-secondary" >바로가기 &raquo;</a></Link>
        </h2>
      </article>

      <img src="search.jpg" height = {630} className="d-block w-100" alt="search"/> <br/><br/><br/><br/>
      <article className='product2'>
        <h2>
        CRP만의 작사 프로그램을 이용해보세요</h2><br/>
        <p><a className="btn btn-secondary" href="/lyrics/lyupload">바로가기 &raquo;</a></p>
      </article>
